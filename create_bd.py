...
SPIDER_TEXT_13_END = 'П,1 - Ничего себе, как тебя скрутило! (после)'
SPIDER_TEXT_2_END = "П,1 - Передохни пока, грубиян. "
SPIDER_TEXT_6_END = "П,1 - Не волнуйся, оно растворится через пару часов. (после)"
SPIDER_TEXT_8_END = "П,1 - Знаешь, тебе бы пора перестать себя так накручивать. (после)"
SPIDER_TEXT_24_END = "П,1 - Не поймал, не поймал, свой обед ты проебал. (после)"
