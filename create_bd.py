...
Ж:- Давай, паучок, только здесь мы еще не смотрели, тут точно должны быть эти ягоды, наша зеленая принцесса не простит мне если я не принесу их для его исследований. Погнали, путешествие на 5 минут, зашли и вышли.;П:- Ну не знаю, мистер Старк, эта пещера выглядит довольно зловеще... Вы слышали стрекотание?;П: Может мы поищем эти ягоды на каких-то других, более дружелюбного вида...;П: Мистер Старк???
"""
